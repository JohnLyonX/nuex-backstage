    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="课程编号" prop="coursesId">
          <el-input v-model="form.coursesId" placeholder="请输入课程编号" />
        </el-form-item>
        <el-form-item label="课程章节" prop="title">
          <el-input v-model="form.title" placeholder="请输入课程章节" />
        </el-form-item>
        <el-form-item label="父ID" prop="parentId">
          <treeselect v-model="form.parentId" :options="coursesChapterOptions" :normalizer="normalizer" placeholder="请选择父ID" />
        </el-form-item>
      </el-form>
