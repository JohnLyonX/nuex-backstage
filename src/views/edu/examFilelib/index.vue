<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="课程章节" prop="coursesChapter">
        <el-input
          v-model="queryParams.coursesChapter"
          placeholder="请输入课程章节"
          clearable
          @keyup.enter.native="handleQuery"
        />
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['edu:examFilelib:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
    ...
    <el-table v-loading="loading" :data="examFilelibList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="课程章节" align="center" prop="coursesChapter" />
      <el-table-column label="文件提交路径" align="center" prop="subPath" />
      <el-table-column label="批改后的文件路径" align="center" prop="correctPath" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="课程章节" prop="coursesChapter">
          <el-input v-model="form.coursesChapter" placeholder="请输入课程章节" />
        </el-form-item>
        <el-form-item label="文件提交路径" prop="subPath">
          <file-upload v-model="form.subPath"/>
        </el-form-item>
        <el-form-item label="批改后的文件路径" prop="correctPath">
          <file-upload v-model="form.correctPath"/>
        </el-form-item>
      </el-form>
...
<script>
import { listExamFilelib, getExamFilelib, delExamFilelib, addExamFilelib, updateExamFilelib } from "@/api/edu/examFilelib";
